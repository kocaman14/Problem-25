        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          ...
          >
            <div className='flex flex-col justify-center rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 lg:z-10 lg:rounded-b-none'>
              ...
              onClick={handleClick}
                href='#'
                className={`mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ${click ? 'bg-orange-600' : 'bg-indigo-600'} text-white shadow-sm hover:bg-orange-500`}
              >
                Satın alma planı
              </a>
            </div>
